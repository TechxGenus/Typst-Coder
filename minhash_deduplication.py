# Ref: https://github.com/bigcode-project/bigcode-dataset/blob/main/near_deduplication/minhash_deduplication.py
#!/usr/bin/env python
# -*- coding: utf-8 -*-
...
if __name__ == "__main__":
    ...
    def run(
        ...
        # )
        ds = load_dataset(
            'json', data_files=dataset, split=split
        )
